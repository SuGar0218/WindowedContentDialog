    ...
    protected void DetermineButtonText()
    {
        switch (_buttons)
        {
            ...
            case MessageBoxButtons.OKCancel:
            {
                ...
                _dialog.PrimaryButtonText = cancelString.Text;
                _dialog.PrimaryButtonKeyboardAccelerators.Add(new KeyboardAccelerator { Key = cancelString.Key });
                _dialog.SecondaryButtonText = NativeMessageBoxButtonStringLoader.Cancel;
                break;
            }
